...
from bot.core.handlers.handle_mirror import handle_mirror_command, handle_qbit_mirror_command, handle_unzip_mirror_command, handle_zip_mirror_command
...
from bot.core.menus.callbacks.qbitsel_callback import get_confirm
...
async def booted(client):
    if ospath.isfile(".updatemsg"):
        ...
        await client.edit_message(chat_id=cht_id, message_id=msg_id, text="Restarted successfully!")
        osremove(".updatemsg")
    await client.send_message(OWNER_ID, text="The bot is ready to use")
